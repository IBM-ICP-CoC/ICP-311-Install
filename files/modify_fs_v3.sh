...
# This script takes 1 value that must be passed in. 
#  exzample:  make_fs.sh 499
#  The value is for the /var drive (I have a 500GB)
...
lvcreate -L $1G -n var-lv var-vg   #  The $1  is the first argument passed into the script
